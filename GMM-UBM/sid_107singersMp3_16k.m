clear
clc
load 'result_107singersMp3_20_fold_16k/gmm_ubm.mat';
for theta = 0.07%0 : 0.01 : 0.1
    ...
    for ispeaker = [10001 : 10107]
        cepsmat = [];
        files = dir(['dataset/107singersMp3_20_fold_16k/', num2str(ispeaker), '/test/*.wav']);
        for ifile = 1 : length(files)
            [d, sr] = wavread(['dataset/107singersMp3_20_fold_16k/', num2str(ispeaker), '/test/', files(ifile).name]);
        ...
        for imodel = 10001 : 10107
            %disp('imodel====================');
            %disp(imodel);
            load(['result_107singersMp3_20_fold_16k/gmm_speaker_', num2str(imodel), '.mat']);
